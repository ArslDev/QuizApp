...
import 'package:quiz_app1/admin/add_quiz.dart';
        ...
        child: Stack(
          ...
          margin: EdgeInsets.only(left:  30.0, right: 30.0, top: 60.0),
            child: Form(child: Column(
              children: [
                Text('Lets Start with Admin', style : GoogleFonts.indieFlower( color: Colors.black,fontSize: 25.0, fontWeight: FontWeight.bold)),
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Center(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: 'User Name',
                                hintStyle: GoogleFonts.indieFlower(color: Color.fromARGB(255, 160, 160, 147)),
                                suffixIcon: Icon(Icons.person, color:Color.fromARGB(255, 160, 160, 147) ,)
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: Center(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelText: 'Password',
                                hintStyle: GoogleFonts.indieFlower(color: Color.fromARGB(255, 160, 160, 147)),
                                suffixIcon: Icon(Icons.lock, color: Color.fromARGB(255, 160, 160, 147),)
                              ),
                            ),
                          ),
                        ),
                        ...
                        GestureDetector(
                          onTap: (){
                            loginAdmin();
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>addquiz()));
                          },
                          child: Container(
                            ...
                            child: Center(child: Text(" Login",style: GoogleFonts.indieFlower(fontSize: 20.0, color: Colors.white, fontWeight: FontWeight.bold),),),
                          ),
                        )
                      ],
                    ),
